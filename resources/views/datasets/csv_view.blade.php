...
<div class="container py-4">
    ...
    <div class="row mb-4 align-items-start g-4">
        ...
        <div class="col-lg-5">
            <div class="alert alert-info mb-0 small" role="alert">
                <strong>Preview Cepat</strong><br>
                Ini hanyalah tampilan awal beberapa baris dari file CSV. Untuk analisis lengkap,
                silakan unduh dan buka di aplikasi pengolah data favoritmu.
            </div>
        </div>
    </div>
    ...
    <div class="card shadow-sm border-0">
        <div class="card-header bg-white d-flex justify-content-between align-items-center">
            <span class="fw-semibold">Isi Dataset (CSV)</span>
            <span class="text-muted small">Menampilkan {{ count($rows) }} baris pertama</span>
        </div>
